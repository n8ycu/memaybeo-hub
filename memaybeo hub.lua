...
local Window = OrionLib:MakeWindow({Name = "memaybeo Hub", HidePremium = false, IntroText = "memaybeo gaming Library", SaveConfig = true, ConfigFolder = "memaybeo Gaming Hub"})
----------Tab-----------------------
